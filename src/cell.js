export default class Cell {
  ...
  #reproduce(cells) {
    ...
    const cellOptions = {
      ...
      innerColor: {
        r: this.#mutate(this.innerColor.r, "fixed", 200),
        g: this.#mutate(this.innerColor.g, "fixed", 200),
        b: this.#mutate(this.innerColor.b, "fixed", 200),
        o: this.#mutate(this.innerColor.o, "fixed", 0.1),
      },
      color: {
        r: this.#mutate(this.color.r, "fixed", 200),
        g: this.#mutate(this.color.g, "fixed", 200),
        b: this.#mutate(this.color.b, "fixed", 200),
